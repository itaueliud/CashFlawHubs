...
function RegisterPageContent() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast.success('Account created! Welcome to CashFlawHubs');
      ...
      <div className="relative mx-auto w-full max-w-6xl">
        ...
        >
          ...
          <h1 className="mx-auto max-w-3xl text-4xl font-black tracking-tight text-white md:text-5xl">
            Create your
            <span className="bg-gradient-to-r from-green-300 via-emerald-400 to-cyan-300 bg-clip-text text-transparent"> CashFlawHubs account</span>
          </h1>

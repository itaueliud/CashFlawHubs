    ...
    <div className="max-w-lg mx-auto space-y-6">
      ...
      <div className="card bg-blue-500/10 border-blue-500/30">
        <div className="flex items-start gap-3">
          ...
          <p className="text-sm text-slate-300">The activation fee funds platform operations and deters fake accounts. You can recover it with 3 activated referrals.</p>
        </div>
      </div>

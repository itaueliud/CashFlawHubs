  ...
  return (
    <div className="max-w-lg mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">One-time fee to unlock all earning features</p>
      </div>
      ...
      <div className="card">
        ...
        <div className="space-y-2">
          {[
            'Paid Surveys (up to $3 each)',
            'Microtasks & Offerwalls',
            'Freelance Gig posting',
            'Referral rewards — 200 KES per activated referral',
            'Daily challenges & XP bonuses',
      ...
      <div className="card bg-blue-500/10 border-blue-500/30">
        <div className="flex items-start gap-3">
          ...
          <p className="text-sm text-slate-300">The one-time activation fee covers secure account verification, funds platform operations, and helps deter fake accounts. You can recover it with 3 activated referrals, then keep growing your balance through surveys, ads, and digital missions.</p>
        </div>
      </div>

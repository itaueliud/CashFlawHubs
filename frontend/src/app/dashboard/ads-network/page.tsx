...
function PlacementCard({ placementKey }: { placementKey: PlacementKey }) {
        ...
        <div className="rounded-2xl border border-dashed border-slate-700 bg-slate-900/70 px-4 py-8 text-center">
          {placementKey === 'smartlink' && status === 'ready' && value ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center rounded-lg bg-cyan-400 px-4 py-2 text-sm font-bold text-slate-950 transition-colors hover:bg-cyan-300"
            >

...
const jobSchema = new mongoose.Schema({
  ...
  source: { type: String, enum: ['remotive', 'jobicy', 'remoteok', 'weworkremotely', 'jooble', 'adzuna', 'arbeitnow', 'themuse', 'jsearch', 'careerjet', 'internal', 'scraper'], required: true },
  ...
  // Delivery settings for applications created on the platform
  applicationDelivery: { type: String, enum: ['redirect', 'webhook', 'email', 'internal'], default: 'redirect' },
  employerWebhookUrl: { type: String, default: null },
